...
//             {renderImageBox(imgl, "Speakers", "Amazon wireless speakers.", 12)}
//             {renderImageBox(img9, "Perfume", "GUCCI INTENSE OUD EDP", 12)}
//           </Box>
//         </Box>
//       </Box>
...
export default function NewArrival() {
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 6 } }}>
      ...
      {/* ✅ تعديل هذا القسم لجعله ريسبونسف */}
      <Box
        sx={{
          display: "flex",
          gap: 3,
          alignItems: "stretch",
          justifyContent: "space-between",
          flexDirection: { xs: "column", md: "row" }, // ✅ عمودي على الموبايل
        }}
      >
        {/* الصورة الكبيرة */}
        {renderImageBox(
        ...
        >
          ...
          <Box
            sx={{
              ...
              gap: 3,
              flex: 1,
              flexDirection: { xs: "row", md: "row" }, // ✅ نفس السطر على الموبايل
            }}
          >
            {renderImageBox(imgl, "Speakers", "Amazon wireless speakers.", 12)}
            {renderImageBox(img9, "Perfume", "GUCCI INTENSE OUD EDP", 12)}
