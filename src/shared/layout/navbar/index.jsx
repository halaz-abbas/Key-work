        ...
        <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <Link to="/account" className="flex items-center gap-3  text-white hover:text-white/80 transition-colors">
              <img src="\imges\user.png" alt="Account" className="w-5 h-5" />
              <span>Manage My Account</span>
              </Link>
              <Link to="/orders" className="flex items-center gap-3  text-white hover:text-white/80 transition-colors">
              <img src="\imges\Group.png" alt="Orders" className="w-5 h-5" />
              <span>My Order</span>
              </Link>
              <Link to="/cancellations" className="flex items-center gap-3  text-white hover:text-white/80 transition-colors">
              <img src="\imges\icon-cancel.png" alt="Cancellations" className="w-5 h-5" />
              <span>My Cancellations</span>
              </Link>
              <Link to="/reviews" className="flex items-center gap-3  text-white hover:text-white/80 transition-colors">
              <img src="\imges\Icon-Reviews.png" alt="Reviews" className="w-5 h-5" />
           ...
           >
      <img src="\imges\Vector (1).png" alt="Logout" className="w-5 h-5" />
      <span>Logout</span>
    </button>
  </div>
)}
