          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              ...
              <button className="absolute right-2 top-1/2 transform -translate-y-1/2 p-2 transtion-colors">
                <img src="\imges\icon-send.png" alt="Send" className="w-4 h-4" />
              </button>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <div className="w-[64px] h-[64px] bg-white flex items-center justify-center">
                <img src="\imges\Qr Code (1).png" alt="QR Code" className="w-full h-full" />
              </div>
            
              <div className="flex flex-col gap-2">
                <img src="\imges\photo_2025-10-06_19-57-28.jpg" alt="Google Play" className="w-[120px] h-auto" />
                <img src="\imges\photo_2025-10-06_19-57-38.jpg" alt="App Store" className="w-[120px] h-auto" />
              </div>
            </div>

            <div className="flex gap-4 pt-4">
              <img src="\imges\Icon-Facebook.png" alt="Facebook" className="w-6 h-6" />
              <img src="\imges\Vector.png" alt="Twitter" className="w-6 h-6" />
              <img src="\imges\icon-instagram.png" alt="Instagram" className="w-6 h-6" />
              <img src="\imges\Icon-Linkedin.png" alt="LinkedIn" className="w-6 h-6" />
            </div>
          </div>
        </div>
