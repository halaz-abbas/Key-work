...
function useController(props) {
	...
	import_react.useEffect(() => {
		...
		if (_shouldUnregisterField) {
			const value$1 = cloneObject(get(control._options.defaultValues, name));
...
function useFieldArray(props) {
	...
	import_react.useMemo(() => rules && control.register(name, rules), [
		control,
		rules,
		name
	]);
...
//# sourceMappingURL=index.esm-Bkfax7D7.js.map